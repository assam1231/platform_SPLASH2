...
///////////////////////////////////////////////////////////////////////////////
  ...
  #error ocp_slave_socket_tl3.h may not be included directly. Use #inculde "ocpip.h" or #include "ocpip_X_X_X.h" (where desired ocp version is X.X.X)
#endif
...
class ocp_slave_socket_tl3 : public ocp_slave_socket<BUSWIDTH,NUM_BINDS,BASE_SOCKET>{
public:
  typedef ocp_slave_socket<BUSWIDTH, NUM_BINDS, BASE_SOCKET> base_type;
  ocp_slave_socket_tl3(const char* name)
    : base_type(name, ocp_tl3){}
